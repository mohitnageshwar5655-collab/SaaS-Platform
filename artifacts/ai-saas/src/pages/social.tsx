        ...
        >
          <div className="space-y-3">
            ...
            <Textarea
              ...
              className="h-40 bg-background/50 border-white/10 focus-visible:ring-pink-500 text-base"
            />
          </div>
          ...
          <div className="space-y-3">
            ...
            <select 
              ...
              className="flex h-11 w-full items-center justify-between rounded-xl border border-white/10 bg-background/50 px-3 py-2 text-sm text-white focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent transition-all"
            >
          ...
          <Button
            ...
            className="w-full h-12 text-base font-semibold bg-pink-600 hover:bg-pink-500 text-white rounded-xl shadow-[0_0_20px_rgba(219,39,119,0.3)] hover:shadow-[0_0_25px_rgba(219,39,119,0.5)] transition-all active-elevate-2 hover-elevate border-0"
          >
