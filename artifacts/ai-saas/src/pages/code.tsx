...
export default function CodeGenerator() {
  ...
  const handleGenerate = () => {
    ...
    generate("/api/tools/generate", { toolType: "code", prompt, programmingLanguage, aiModel });
  };
        ...
        >
          ...
          <div className="space-y-3">
            ...
            <Textarea
              ...
              className="h-36 bg-background/50 border-white/10 focus-visible:ring-emerald-500 font-mono text-sm"
            />
          </div>
          ...
          <div className="space-y-3">
            ...
            <select
              ...
              className="flex h-11 w-full rounded-xl border border-white/10 bg-background/50 px-3 py-2 text-sm text-white focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all"
            >
          ...
          <Button
            ...
            className="w-full h-12 text-base font-semibold bg-emerald-600 hover:bg-emerald-500 text-white rounded-xl shadow-[0_0_20px_rgba(16,185,129,0.3)] hover:shadow-[0_0_25px_rgba(16,185,129,0.5)] transition-all border-0"
          >
            {isLoading ? <Loader2 className="w-5 h-5 mr-2 animate-spin" /> : <Code2 className="w-5 h-5 mr-2" />}
            {isLimitReached ? "Daily Limit Reached" : "Generate Code"}
          </Button>
        </motion.div>
